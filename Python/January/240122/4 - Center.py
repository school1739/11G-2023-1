...
def center(s, w): #Ввод функции
    sp = ""
    sps = " "
    if len(s) >= w: #Ввод условия
        print(s) #Вывод результата
    else:
        for i in range((w - len(s)) // 2): #Ввод цикла
            sp += sps
        print(sp + s) #Вывод результата
center(input("Введите строку: "), int(input("Введите ширину окна: "))) #Ввод данных