...
commands = {
    'Привет!':
        lambda msg: bot.send_message(msg.chat.id, 'Здравствуйте'),
    'help':
        lambda msg: bot.send_message(msg.chat.id, 'Помощь'),
    'timothy':
...
def get_text_messages(msg: types.Message):
    ...
    if answer is None:
        bot.send_message(msg.chat.id, 'Такой команды не существует')
        return
    answer(msg)
