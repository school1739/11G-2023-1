...
# подсчет округленного значения времени звучания трех песен
three_hits = round(violator_songs[3][1] + violator_songs[5][1] + violator_songs[8][1], 2)

# вывод значения общего времени звучания трех песен
print('Три песни звучат', three_hits,  'минут.')
...
# значения времени песен из словаря
...
# считаем и округляем общее время
another_three_hits = round(on_track + to_the_sea + beyond_mirror)

# вывод общего значения
print('А другие три песни звучат приблизительно', another_three_hits, 'минут.')
