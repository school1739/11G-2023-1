...
bot = telebot.TeleBot('827315252:AAG3MaPfzVEPFkaawp753lF6xpNx0RCi')

os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = 'jababot-mfps-bb320d66ef80.json'

DIALOGFLOW_PROJECT_ID = 'jababot-mfps'
...
def start_message(msg: types.Message):
    bot.send_message(msg.chat.id, 'Кто я?!')
