...
# Монетки норм, второе задание не работает (ошибка ниже), так ещё и не НОК мы искали, а Наибольший общий делитель (НОД)
# P.S.: Забыл отформатировать файл перед коммитом