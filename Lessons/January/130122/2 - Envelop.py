...
envelop_x = int(input("Введите ширину"))
envelop_y = int(input("Введите длину"))

paper_size =[[8,9],[9,8],[6,8],[8,6],[3,4],[11,9],[9,11]]

for papers in paper_size :
...
hole_x = int(input("ширина"))
hole_y = int(input("длина"))

brick_size = [[11,10,2],[11,2,10],[10,11,2],[10,2,11],[2,10,11],[2,11,10],[3,5,6],[3,6,5],[6,3,5],[6,5,3],[5,6,3],[5,3,6],[11,3,6],[11,6,3],[6,11,3],[6,3,11],[3,6,11],[3,11,6]]
for bricks in brick_size:
